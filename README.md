...
Step 1:- Open backend folder in node js command promt. Use npm run dev command.

Step 2:- Open Mandar-anular-practise folder.And run npm install and then npm start.
